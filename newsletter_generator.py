...
<table width="600" cellpadding="0" cellspacing="0" style="max-width:600px; width:100%;">
  ...
  <tr><td style="padding:16px 32px 24px; text-align:center; color:#9aa39c; font-size:11px; border:2px solid #D9A441; border-top:none; border-radius:0 0 8px 8px;">
    ...
    You're getting this because you signed up at the Trailhead.
    <a href="mailto:strongsvilletrailhead@gmail.com?subject=Unsubscribe" style="color:#9aa39c; text-decoration:underline;">Unsubscribe</a> any time.
  </td></tr>
...
def send_newsletter(html, subscribers):
    ...
    for i in range(0, len(subscribers), BATCH):
        ...
        # Spam filters look for a machine-readable unsubscribe route. Gmail and
        # Outlook surface this as their own "Unsubscribe" link next to the sender.
        unsub = os.environ.get("UNSUBSCRIBE_EMAIL", reply_to).strip()
        if unsub:
